...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/opt/data/private/HSJ/dataset/',
...
parser.add_argument('--data_test', type=str, default='Set5',
                    help='test dataset name') #Set5+Set14+B100+Urban100+Manga109
...
parser.add_argument('--model', default='HFEN',                         ####HFEN
                    help='model name')
...
parser.add_argument('--batch_size', type=int, default=16,        ###############3####
